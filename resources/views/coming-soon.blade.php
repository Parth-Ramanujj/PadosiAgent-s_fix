...
<body>
    <div class="full-width container">
        ...
        <main class="main-content">
            <div class="content-wrapper">
                ...
                <!-- State-wise Agent Counter (REPLACED COUNTDOWN TIMER) -->
                <div class="state-counter-container">
                    <div class="state-counter-item">
                        <div class="state-counter-circle">
                            <img src="{{ asset('images/circle-timer.png') }}" class="circle-bg" alt="Gujarat counter">
                            <span class="state-counter-number" id="gujaratCount">0</span>
                        </div>
                        <div class="state-counter-label">Gujarat</div>
                        <div class="state-counter-subtitle">Agents</div>
                    </div>

                    <div class="state-counter-item">
                        <div class="state-counter-circle">
                            <img src="{{ asset('images/circle-timer.png') }}" class="circle-bg" alt="Rajasthan counter">
                            <span class="state-counter-number" id="rajasthanCount">0</span>
                        </div>
                        <div class="state-counter-label">Rajasthan</div>
                        <div class="state-counter-subtitle">Agents</div>
                    </div>
                    <div class="state-counter-item">
                        <div class="state-counter-circle">
                            <img src="{{ asset('images/circle-timer.png') }}" class="circle-bg" alt="Delhi counter">
                            <span class="state-counter-number" id="delhiCount">0</span>
                        </div>
                        <div class="state-counter-label">Delhi</div>
                        <div class="state-counter-subtitle">Agents</div>
                    </div>
                    <div class="state-counter-item">
                        <div class="state-counter-circle">
                            <img src="{{ asset('images/circle-timer.png') }}" class="circle-bg" alt="Maharashtra counter">
                            <span class="state-counter-number" id="maharashtraCount">0</span>
                        </div>
                        <div class="state-counter-label">Maharashtra</div>
                        <div class="state-counter-subtitle">Agents</div>
                    </div>
                    <div class="state-counter-item">
                        <div class="state-counter-circle">
                            <img src="{{ asset('images/circle-timer.png') }}" class="circle-bg" alt="MP counter">
                            <span class="state-counter-number" id="mpCount">0</span>
                        </div>
                        <div class="state-counter-label">Madhya Pradesh</div>
                        <div class="state-counter-subtitle">Agents</div>
                    </div>
                </div>
    ...
    <script>
        // State Counter Animation Script
        document.addEventListener('DOMContentLoaded', function () {
            // State targets (different for each state)
            const stateTargets = {
                gujarat: 65,
                rajasthan: 38,
                maharashtra: 50,
            ...
            // Speed of counting (ms per count)
            const countSpeed = 100;
            
            // Function to animate counter
            function animateCounter(elementId, target, current = 0) {
                const element = document.getElementById(elementId);
                if (!element) return;
                
                const increment = Math.ceil(target / 50); // Complete in 50 steps max
            ...
            // Start all counters with a slight delay between each
            setTimeout(() => animateCounter('gujaratCount', stateTargets.gujarat), 500);
            setTimeout(() => animateCounter('rajasthanCount', stateTargets.rajasthan), 700);
            setTimeout(() => animateCounter('maharashtraCount', stateTargets.maharashtra), 900);
            setTimeout(() => animateCounter('delhiCount', stateTargets.delhi), 1100);
            setTimeout(() => animateCounter('mpCount', stateTargets.mp), 1300);
