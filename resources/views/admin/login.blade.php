...
<div class="login-container">
  <div class="login-logo">
    <img src="{{ asset('admin_assets/images/logo.png') }}" alt="PadosiAgent Admin">
  </div>
  ...
  <div class="card">
    ...
    <form method="POST" action="{{ route('admin.login') }}">
      ...
      <div class="form-group">
        ...
        <input type="email" name="email" value="{{ old('email') }}" placeholder="admin@padosiagent.com" required autofocus>
      </div>
